...
// NOTE: NewPricingClient was removed from ClientFactory because on-demand pricing
// is now fetched from the public AWS bulk pricing URL via HTTP, not the Pricing API.
